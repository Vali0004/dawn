#pragma once
#include "pch/pch.h"
#define COUNT(x) (x ? sizeof(x) / sizeof(*x) : 0)
// Stolen from Soup with modifications to improve speed and instructions to disassemble
// https://github.com/calamity-inc/Soup
// Licensed under MIT
